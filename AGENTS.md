# ACTA contributor instructions

Read [README.md](README.md), [docs/plan.md](docs/plan.md) and [docs/privacy-security.md](docs/privacy-security.md) before changing the project.
...
- Use relative links between repository documents. Avoid links to a contributor's private filesystem.
- For documentation-only work, check whitespace, links and consistency; do not claim application tests were run.
